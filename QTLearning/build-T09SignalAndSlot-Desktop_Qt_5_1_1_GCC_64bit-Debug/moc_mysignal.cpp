...
#include "../T09SignalAndSlot/mysignal.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MySignal_t, stringdata) + ofs \
...
void MySignal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MySignal::sig)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MySignal::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MySignal.data,
      qt_meta_data_MySignal,  qt_static_metacall, 0, 0}
};
